    ...
    if (data) {
      ...
      const withProfiles = data.map(r => {
        ...
        return {
          ...
          reporter_phone: profile?.phone || undefined,
        };
      });
  ...
  return (
    <Layout>
            ...
            <div className="space-y-6">
              <Card className="bg-destructive/5 border-destructive/20">
                <CardContent className="pt-6">
                  ...
                  <p className="text-2xl font-bold text-destructive mb-2">1-800-PET-HELP</p>
      ...
      <ContactReporterDialog
        ...
        reporterName={contactReport?.reporter_name}
        reporterEmail={contactReport?.reporter_email}
        reporterPhone={contactReport?.reporter_phone}
      />
    </Layout>
  );
}
